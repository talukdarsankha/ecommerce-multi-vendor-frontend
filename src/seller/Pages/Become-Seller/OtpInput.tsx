...
export default function OtpInput({otps,handleOtpChange,handleKeyDownForOtp, canResend, handleResendOtp, timer}:{otps:any, handleOtpChange:any ,handleKeyDownForOtp:any , canResend:any, handleResendOtp:any, timer:any}) {
